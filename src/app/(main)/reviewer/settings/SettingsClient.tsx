...
const STORAGE_KEY = "cir_reviewer_preferences";
    ...
    <div className="mx-auto max-w-2xl space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-[#627D98]">
          Your preferences and account controls.
        </p>
      </div>
      ...
      <Section title="Notifications">
        <ToggleRow
          ...
          description="Receive updates about your reviews by email."
        ...
        <ToggleRow
          ...
          description="Show notifications in the reviewer panel."
